            ...
            {open &&
                <Overlay>
                    <ModalWrapper>
                        ...
                        <ModalFooter>
                            <Button buttonStyle={'primary'} label={action} isRound onClick={() => {
                                handleClose();
                                onClick();
                            }} />
                        </ModalFooter>
...
function IconContainer({ onClick }: IconContainerProps) {
    return (<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill={theme.color.text_gray_color} style={{ cursor: "pointer" }} onClick={() => onClick()}>
